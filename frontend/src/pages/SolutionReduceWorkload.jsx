...
export default function SolutionReduceWorkload() {
  return <div data-testid="page-solution-reduce">
    <PageHero title="Get your time back." text="Give repetitive tasks a reliable process, so your team can focus on customers and the work that needs them." image="calm-lake" imageAlt="Soft morning light over a quiet lake, with gentle ripples around a shoreline stone"><BookingLink testId="solution-reduce-cta-top" /></PageHero>
    ...
    <ClosingSection title="Start with one task." text="Tell us where the busywork builds up. We’ll help you find a practical place to start." />
