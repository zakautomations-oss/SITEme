...
export default function SolutionReduceWorkload() {
  return <div data-testid="page-solution-reduce">
    <PageHero title="Get your time back." text="Give repetitive tasks a reliable process, so your team can focus on customers and the work that needs them." image="workflow" imageAlt="A clear workspace with a notebook, pen, and laptop"><BookingLink testId="solution-reduce-cta-top" /></PageHero>
