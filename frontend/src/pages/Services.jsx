...
export default function Services() {
  return <div data-testid="page-services">
    <PageHero eyebrow="The process" title="A clear plan. A working agent." text="From your first conversation to live traffic, you’ll know what we’re building and how to evaluate it." image="workflow" imageAlt="An open notebook ready for a working plan">
